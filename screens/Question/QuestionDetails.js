...
export default function QuestionDetails({ question, answerQuestion }) {
  ...
  if (questionNumber === 0) {
    setAnswers([...question.incorrect_answers, question.correct_answer].sort(() => Math.random() - 0.5));
    setQuestionNumber(1);
  }
      ...
      <View style={styles.timer}>
        ...
        >
          {({ remainingTime, animatedColor }) => (
            <Animated.Text style={{ color: animatedColor, fontSize: 28 }}>{remainingTime}</Animated.Text>
          )}
        </CountdownCircleTimer>
      </View>,
    );
        ...
        <>
                ...
                onPress={() => {
                  if (!click) {
                    ...
                    if (answer === question.correct_answer) {
                      ...
                      index === 0 &&
                        (setBGColor([
                          themeCorrectButtonStyle,
                          themeButtonStyle,
                          themeButtonStyle,
                          themeButtonStyle,
                        ]),
                        setBColor([
                          themeCorrectBorderStyle,
                          themeBorderStyle,
                          themeBorderStyle,
                          themeBorderStyle,
                        ]));
                      ...
                      index === 0 &&
                        ...
                        setBColor(['#A50000', themeBorderStyle, themeBorderStyle, themeBorderStyle]));
                      index === 1 &&
                        (setBGColor([
                          themeButtonStyle,
                          themeBadButtonStyle,
                        ...
                        setBColor([themeBorderStyle, '#A50000', themeBorderStyle, themeBorderStyle]));
                      index === 2 &&
                        (setBGColor([
                          themeButtonStyle,
                          themeButtonStyle,
                        ...
                        setBColor([themeBorderStyle, themeBorderStyle, '#A50000', themeBorderStyle]));
                      index === 3 &&
                        (setBGColor([
                          themeButtonStyle,
                          themeButtonStyle,
                        ...
                        setBColor([themeBorderStyle, themeBorderStyle, themeBorderStyle, '#A50000']));
                    }
                    setTimeout(() => {
          ...
          <View style={styles.answers}>
            <Text style={[styles.name, themeTitleStyle]}>
              Correct: {correctCounter}/{NUMBER}
            </Text>
            <Text style={[styles.name, themeTitleStyle]}>
              Incorrect: {incorrectCounter}/{NUMBER}
            </Text>
          </View>
        </>
      );
          ...
          {answers.map((answer) => (
            <TouchableOpacity
              ...
              style={{
                ...
                height: 50,
                backgroundColor:
                  answer === question.correct_answer ? themeTimeButtonStyle : themeButtonStyle,
                borderRadius: 18,
                justifyContent: 'center',
                alignItems: 'center',
                margin: 10,
